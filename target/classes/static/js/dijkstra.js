document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('startBtn').addEventListener('click', () => {
        if (startNode && targetNode) {
            ...
            resetPathAndVisitedStates(grid);
            runDijkstra(grid, startNode, targetNode, delay, allowDiagonals);
        } else {
    ...
    function runDijkstra(grid, startNode, targetNode, delay, allowDiagonals) {
        ...
        function step() {
            ...
            // Sort openSet by distance and pick the node with the lowest distance
